...
print(bit1, "Bitwise AND", bit2, ":", bin(bit1 & bit2))
print(bit1, "Bitwise OR", bit2, ":", bin(bit1 | bit2))
print(bit1, "Bitwise XOR", bit2, ":", bin(bit1 ^ bit2))
print(bit1, "Bitwise NOT", bit2, ":", bin(~bit1))
print(bit1, "Left Shift by 1 :", bin(bit1 << 1))
print(bit1, "Right Shift by 1 :", bin(bit1 >> 1))
